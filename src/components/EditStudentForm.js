        ...
        return (
            <div>
                ...
                <form className="edit-student-form" handleSubmit={(e) => console.log(e)}>
                    <label>Name:</label>
                    <input name="name" placeholder={name} className="student-input" value={this.state.name} onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} type="text" />
                    <label>School id:</label>
                    <input type="text" name="school_id" value={this.state.school_id} placeholder={school_id }className="student-input" onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} />
                    <label>Reason:</label>
                    <input type="text" name="reason" value={this.state.reason} placeholder={reason} className="student-input" onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} />
                    ...
                    <label>School: </label>
                    <input  type="text" name="school" value={this.state.school} placeholder={school} className="student-input" onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} />
                    <label>Grade:</label>
                    ...
                    <label>SPED: </label>
                    <select name="sped "  type="boolean" placeholder={sped} className="student-input" onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} >
                        <option value={null} > --- </option>
                        <option value={true} > Yes </option>
                        <option value={this.state.sped} > No </option>
                    </select>
                    <label>Councilor Info:</label>
                    <textarea row="5" col="60" value={this.state.counselor_info} placeholder={counselor_info} className="student-input" onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} name="counselor_info" />
                    {/* <br /> */}
                    <h3>Guardian Info</h3>
                    <label>Name:</label>
                    <input type="text" value={this.state.guardian} placeholder={guardian} className="student-input" onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} name="guardian"/>
                    <label>Address:</label>
                    <input type="text" value={this.state.address} placeholder={address} className="student-input" onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} name="address" />
                    <label>Cell:</label>
                    <input value={this.state.cell} type="text" placeholder={cell} className="student-input" onChange={this.handleChange} style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} name="cell" />
                    <label>Phone:</label>
                <input value={ this.state.home_no} type="text" placeholder={home_no} className="student-input" onChange={this.handleChange} name="home_no" style={{ width: "75%", fontSize: ".50em", borderRadius: ".25em" }} />
                    <label>Email:</label>
